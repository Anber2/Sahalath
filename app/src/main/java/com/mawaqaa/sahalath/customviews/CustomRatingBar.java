...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.ic_rating_bar_star_active;
    private int mStarOffResource = R.drawable.ic_rating_bar_star_inactive;
    private int mStarHalfResource = R.drawable.ic_rating_bar_star_active;
