...
/**
 * Created by anson on 3/19/2017.
 */

public class SearchCircleLayoutOuter extends ViewGroup {
    ...
    // Event listeners
    private OnOuterItemClickListener onOuterItemClickListener = null;
    private OnOuterItemSelectedListener onOuterItemSelectedListener = null;
    private OnOuterCenterClickListener onOuterCenterClickListener = null;
    private OnOuterRotationFinishedListener onOuterRotationFinishedListener = null;
    ...
    public SearchCircleLayoutOuter(Context context) {
        this(context, null);
    }

    public SearchCircleLayoutOuter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SearchCircleLayoutOuter(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SearchCircleLayout);

            speed = a.getInt(R.styleable.SearchCircleLayout_speed, speed);
            radius = a.getDimension(R.styleable.SearchCircleLayout_radius, radius);
            isRotating = a.getBoolean(R.styleable.SearchCircleLayout_isRotating, isRotating);

            // The angle where the first menu item will be drawn
            angle = a.getInt(R.styleable.SearchCircleLayout_firstChildPosition, (int) angle);
    ...
    private void setChildAngles() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (isFirstItem && selectedView != child) {
                selectedView = child;
                if (onOuterItemSelectedListener != null && isRotating) {
                    onOuterItemSelectedListener.onOuterItemSelected(child);
                }
            }
    ...
    private void animateTo(float endDegree, long duration) {
        ...
        animator = ObjectAnimator.ofFloat(SearchCircleLayoutOuter.this, "angle", angle, endDegree);
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (onOuterRotationFinishedListener != null) {
...
//                    onRotationFinishedListener. onRotationFinished(view);
    ...
    private class MyGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            if (tappedViewsPosition >= 0) {
                ...
                if (onOuterCenterClickListener != null
                        && e.getX() < centerX + radius - (maxChildWidth / 2)
                        && e.getX() > centerX - radius + (maxChildWidth / 2)
                        && e.getY() < centerY + radius - (maxChildHeight / 2)
                        && e.getY() > centerY - radius + (maxChildHeight / 2)) {
                    onOuterCenterClickListener.onOuterCenterClick();
                    return true;
                }
            }
            ...
            if (tappedView != null) {
                if (selectedView == tappedView) {
                    if (onOuterItemClickListener != null) {
                        onOuterItemClickListener.onOuterItemClick(tappedView);
                    }
                } else {
                    rotateViewToCenter(tappedView);
                    if (!isRotating) {
                        if (onOuterItemSelectedListener != null) {
                            onOuterItemSelectedListener.onOuterItemSelected(tappedView);
                        }
    ...
    public interface OnOuterItemClickListener {
        void onOuterItemClick(View view);
    }

    public void setOnOuterItemClickListener(OnOuterItemClickListener onOuterItemClickListener) {
        this.onOuterItemClickListener = onOuterItemClickListener;
    }

    public interface OnOuterItemSelectedListener {
        void onOuterItemSelected(View view);
    }

    public void setOnOuterItemSelectedListener(
            OnOuterItemSelectedListener onOuterItemSelectedListener) {
        this.onOuterItemSelectedListener = onOuterItemSelectedListener;
    }

    public interface OnOuterCenterClickListener {
        void onOuterCenterClick();
    }

    public void setOnOuterCenterClickListener(
            OnOuterCenterClickListener onOuterCenterClickListener) {
        this.onOuterCenterClickListener = onOuterCenterClickListener;
    }

    public interface OnOuterRotationFinishedListener {
        void onOuterRotationFinished(View view);
    }

    public void setOnOuterRotationFinishedListener(
            OnOuterRotationFinishedListener onOuterRotationFinishedListener) {
        this.onOuterRotationFinishedListener = onOuterRotationFinishedListener;
    }
}
