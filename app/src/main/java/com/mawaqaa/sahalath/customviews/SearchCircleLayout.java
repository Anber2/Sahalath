...
/**
 * Created by anson on 3/16/2017.
 */

public class SearchCircleLayout extends ViewGroup {
    ...
    public SearchCircleLayout(Context context) {
        this(context, null);
    }

    public SearchCircleLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SearchCircleLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void animateTo(float endDegree, long duration) {
        ...
        animator = ObjectAnimator.ofFloat(SearchCircleLayout.this, "angle", angle, endDegree);
