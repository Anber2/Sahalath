...
public class AllRestListPageFragment extends SahalathBaseFragment {
    ...
    private void initView(View view) {
        ...
        tvCommonTitle.setText(getResources().getString(R.string.all_restaurants));
    }
    ...
    public void onResume() {
        ...
        bottomBarHandlingUtility.allRestPage();
    }
}
