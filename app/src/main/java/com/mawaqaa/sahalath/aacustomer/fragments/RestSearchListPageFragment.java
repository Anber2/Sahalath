...
/**
 * Created by anson on 3/6/2017.
 */

public class RestSearchListPageFragment extends SahalathBaseFragment {
    ...
    private void initView(View view) {
        ...
        tvCommonTitle.setText(getResources().getString(R.string.restaurants));
    }
