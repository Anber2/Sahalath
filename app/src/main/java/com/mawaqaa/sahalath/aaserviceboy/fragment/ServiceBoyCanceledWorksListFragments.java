...
import com.mawaqaa.sahalath.aaserviceboy.adapter.CanceledWorksAdapter;
...
public class ServiceBoyCanceledWorksListFragments extends SahalathBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_sb_canceled_work_list, container,
                false);
        initView(v);
        loadPendingRequests();
    ...
    private void loadPendingRequests() {
        CanceledWorksAdapter adapter = new CanceledWorksAdapter(Activity, serviceRequestsDatas);
        listViewCompletedWorks.setAdapter(adapter);
    }

    private void initView(View v) {
        listViewCompletedWorks = (ListView) v.findViewById(R.id.list_view_cancelled_works);
    }
