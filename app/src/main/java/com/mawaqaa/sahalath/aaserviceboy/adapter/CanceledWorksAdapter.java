...
public class CanceledWorksAdapter extends ArrayAdapter<ServiceRequestsData> {
    Activity activity;
    ArrayList<ServiceRequestsData> serviceRequestsDatas;

    public CanceledWorksAdapter(Activity activity, ArrayList<ServiceRequestsData> serviceRequestsDatas) {
    ...
    static class CanceledWorksViewHolder {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            CanceledWorksViewHolder viewHolder = new  CanceledWorksViewHolder();
        ...
        CanceledWorksViewHolder holder = (CanceledWorksViewHolder) rowView.getTag();
